...
The method does 2 things:
  ...
  1.2. Based on the input number, update the answers array. For example, if
   the option is 3, increase the value AT POSITION 3 of the array by 1.
...
BONUS: Use the 'displayResults' method to display the 2 arrays in the test data.
 Use both the 'array' and the 'string' option. Do NOT put the arrays in
 the poll object! So what should the keyword look like in this situation?
...
$('.poll').addEventListener('click', poll.registerNewAnswer.bind(poll));
